...
The booking-window options apply to every generator. Filtering is on each slot's
**start**, and the bookable span is half-open: a slot starting exactly at the
notice boundary is kept, one starting exactly at the advance cutoff is not.
